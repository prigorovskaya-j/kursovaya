<main>
    ...
    <div class="content-wrapper">
        <div class="grey-block education-page">
            <p><span class="text-bold">Университет:</span> Севастопольский Государственный университет</p>
            <p><span class="text-bold">Кафедра:</span> Информационные системы</p>
            <table border="1" width="80%">
                <caption></caption>
                <tr>
                    <td rowspan="3">№</td>
                    <td rowspan="3">Дисциплина</td>
                    <td colspan="12">Часов в неделю
                        <br>(Лекций, Лаб.раб., Практ.раб.)
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>5</td>
                    <td><a href="/test/" class="textHyper">Основы программирования и алгориметрические языки</a></td>
                    <td>3</td>
                    <td>2</td>
                    <td>0</td>
                    <td>3</td>
                ...
                <tr>
                    <td>7</td>
                    <td>Теории вероятности и математическая стаистика</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
